...
import com.loc.newsapp.presentation.Dimens.IndicatorWidth
...
fun OnBoardingScreen(
    ...
    Column(modifier = Modifier
        ...
        HorizontalPager(modifier = Modifier.fillMaxHeight(0.8f),
        ...
        Row(
            ...
            PageIndicator(
                ...
                pageCount = pages.size, selectedPage = pagerState.currentPage
            )
